      ...
      <div class="card-body">
        ...
        <div class="flex justify-between items-center mt-4">
          ...
          <div class="flex items-center transition-all duration-500 ease-in-out transform hover:scale-110" 
               >
            <span class="text-sm mr-2">服务器状态:</span>
            <div class="indicator-item badge badge-md font-bold"
                 :class="{
                   'badge-success': heartbeatStatus === 'connected',
                   'badge-error': heartbeatStatus === 'disconnected',
                   'pulse-animation': heartbeatStatus === 'connected'
                 }">
              {{ heartbeatStatus === 'connected' ? '已连接' : '已断开' }}
            </div>
          </div>
        </div>
